...
const IMAGES: Array<{ id: string; prompt: string }> = [
  ...
  { id: 'char_milei',       prompt: 'Javier Milei caricature portrait, wild electrified black hair, intense eyes, red tie, big chainsaw, libertarian president Argentina, white background' + STYLE_SUFFIX },
  { id: 'char_massa',       prompt: 'Sergio Massa caricature portrait, flat dark hair, navy suit, briefcase, economy minister Argentina, campaign smile, white background' + STYLE_SUFFIX },
  { id: 'char_bullrich',    prompt: 'Patricia Bullrich caricature portrait, wavy blonde hair, teal blazer, stern expression, Argentine security minister, white background' + STYLE_SUFFIX },
